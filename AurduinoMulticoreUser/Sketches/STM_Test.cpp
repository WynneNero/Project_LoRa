...
void loop2() {
  // put your main code for core 2 here, to run repeatedly:
	...
	if(GetCpuCoreID() == 2u)
	{
		SRC_STM2SR0.B.SRE = 0; /*  Disable intr STM2 */
		SRC_STM2SR1.B.SRE = 0; /*  Disable intr STM2  */
	}
	...
	InstructionsPerSecond = (1000 * (float)NoOfLoops)/((float)ExecutionTime * 0.01E-6);
