...
const byte ip[] = { 192, 168, 3, 177 };  // does not work if this is put into Flash
// the router's gateway address:
const byte gateway[] PROGMEM = { 192, 168, 3, 1 };
// the subnet:
const byte subnet[] PROGMEM = { 255, 255, 255, 0 };

EthernetServer server(8089);  // Makes it visible from outside Hitex UK
...
void setup() {
  ...
  SerialASC.begin(115200);       // for debugging
